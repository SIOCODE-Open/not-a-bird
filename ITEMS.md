...
* **Frosted** (`1`): We need a description here
...
* **Warm** (`1`): We need a description here
...
* **Molten** (`1`): We need a description here
...
* **Fertile** (`1`): We need a description here
...
* **Scorched** (`1`): We need a description here
...
* **Charred** (`1`): We need a description here
* **Echo** (`1`): We need a description here
* **Cave** (`1`): We need a description here
* **Underground** (`1`): We need a description here
* **Whispering** (`1`): We need a description here
* **Spring** (`1`): We need a description here
* **Fountain** (`1`): We need a description here
* **Cool** (`1`): We need a description here
* **Monument** (`1`): We need a description here
* **Waterfall** (`1`): We need a description here
* **Eternal** (`1`): We need a description here
* **Pillar** (`1`): We need a description here
...
* **Parched** (`1`): We need a description here
* **Fresh** (`1`): We need a description here
* **Groundwater** (`1`): We need a description here
* **Reservoir** (`1`): We need a description here
* **Geothermal** (`1`): We need a description here
* **Artesian** (`1`): We need a description here
* **Basin** (`1`): We need a description here
* **Lake** (`1`): We need a description here
* **Dry** (`1`): We need a description here
...
* **Hot** (`1`): We need a description here
...
* **Make Frosted** (`1 + 1 -> 1`) - **Glass** + **Water** -> **Frosted**: We need a description here
...
* **Make Magma** (`1 + 1 -> 1`) - **Earth** + **Lava** -> **Magma**: We need a description here
* **Make Breeze** (`1 + 1 -> 1`) - **Wind** + **Dust** -> **Breeze**: We need a description here
* **Make Warm** (`1 + 1 -> 1`) - **Fire** + **Breeze** -> **Warm**: We need a description here
...
* **Make Molten** (`1 + 1 -> 1`) - **Fire** + **Crystal** -> **Molten**: We need a description here
...
* **Make Sand** (`1 + 1 -> 1`) - **Wind** + **Desert** -> **Sand**: We need a description here
...
* **Make Fertile** (`1 + 1 -> 1`) - **Earth** + **Soil** -> **Fertile**: We need a description here
...
* **Make Scorched** (`1 + 1 -> 1`) - **Fire** + **Valley** -> **Scorched**: We need a description here
...
* **Make Fire** (`1 + 1 -> 1`) - **Fire** + **Delta** -> **Fire**: We need a description here
...
* **Make Charred** (`1 + 1 -> 1`) - **Fire** + **Ravine** -> **Charred**: We need a description here
* **Make Echo** (`1 + 1 -> 1`) - **Wind** + **Ravine** -> **Echo**: We need a description here
* **Make Cave** (`1 + 1 -> 1`) - **Earth** + **Echo** -> **Cave**: We need a description here
* **Make Underground** (`1 + 1 -> 1`) - **Water** + **Cave** -> **Underground**: We need a description here
* **Make Lava** (`1 + 1 -> 1`) - **Fire** + **Cave** -> **Lava**: We need a description here
* **Make Whispering** (`1 + 1 -> 1`) - **Wind** + **Cave** -> **Whispering**: We need a description here
...
* **Make Steam** (`1 + 1 -> 1`) - **Fire** + **Spring** -> **Steam**: We need a description here
* **Make Cool** (`1 + 1 -> 1`) - **Wind** + **Spring** -> **Cool**: We need a description here
...
* **Make Eternal** (`1 + 1 -> 1`) - **Fire** + **Monument** -> **Eternal**: We need a description here
* **Make Pillar** (`1 + 1 -> 1`) - **Wind** + **Monument** -> **Pillar**: We need a description here
...
* **Make Parched** (`1 + 1 -> 1`) - **Fire** + **Watershed** -> **Parched**: We need a description here
* **Make Fresh** (`1 + 1 -> 1`) - **Wind** + **Watershed** -> **Fresh**: We need a description here
...
* **Make Geothermal** (`1 + 1 -> 1`) - **Fire** + **Groundwater** -> **Geothermal**: We need a description here
* **Make Artesian** (`1 + 1 -> 1`) - **Wind** + **Groundwater** -> **Artesian**: We need a description here
...
* **Make Dry** (`1 + 1 -> 1`) - **Fire** + **Basin** -> **Dry**: We need a description here
...
* **Make Magma** (`1 + 1 -> 1`) - **Fire** + **Karst** -> **Magma**: We need a description here
* **Make Blowhole** (`1 + 1 -> 1`) - **Wind** + **Karst** -> **Blowhole**: We need a description here
* **Make Hot** (`1 + 1 -> 1`) - **Earth** + **Geyser** -> **Hot**: We need a description here
* **Make Fountain** (`1 + 1 -> 1`) - **Water** + **Geyser** -> **Fountain**: We need a description here
* **Make Steam** (`1 + 1 -> 1`) - **Fire** + **Geyser** -> **Steam**: We need a description here
