...
pub mod fertile {
    ...
    /** Error type for PSP-22 compatible contract for element 'Fertile' */
    ...
    impl Default for FertileContract {
        fn default() -> Self {
    ...
    impl FertileContract {
        /// Creates a new PSP-22 compatible Fertile Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
