...
pub mod artesian {
    ...
    /** Error type for PSP-22 compatible contract for element 'Artesian' */
    ...
    impl Default for ArtesianContract {
        fn default() -> Self {
    ...
    impl ArtesianContract {
        /// Creates a new PSP-22 compatible Artesian Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
        ...
        pub fn token_name(&self)-> String {
            String::from("Artesian")
        }

        #[ink(message, selector = 0x34205be5)]
        pub fn token_symbol(&self)-> String {
            String::from("MARTESIAN")
        }
