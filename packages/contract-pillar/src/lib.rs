...
pub mod pillar {
    ...
    /** Error type for PSP-22 compatible contract for element 'Pillar' */
    ...
    impl Default for PillarContract {
        fn default() -> Self {
    ...
    impl PillarContract {
        /// Creates a new PSP-22 compatible Pillar Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
