...
pub mod whispering {
    ...
    /** Error type for PSP-22 compatible contract for element 'Whispering' */
    ...
    impl Default for WhisperingContract {
        fn default() -> Self {
    ...
    impl WhisperingContract {
        /// Creates a new PSP-22 compatible Whispering Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
