...
const ELEMENT_FROSTED: Element = Element {
    id: 59,
    name: "Frosted",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_WARM: Element = Element {
    id: 85,
    name: "Warm",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_MOLTEN: Element = Element {
    id: 95,
    name: "Molten",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_FERTILE: Element = Element {
    id: 110,
    name: "Fertile",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_SCORCHED: Element = Element {
    id: 116,
    name: "Scorched",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_CHARRED: Element = Element {
    id: 122,
    name: "Charred",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_UNDERGROUND: Element = Element {
    id: 125,
    name: "Underground",
    description: "We need a description here",
    tier: 1,
};
const ELEMENT_WHISPERING: Element = Element {
    id: 126,
    name: "Whispering",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_COOL: Element = Element {
    id: 129,
    name: "Cool",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_ETERNAL: Element = Element {
    id: 132,
    name: "Eternal",
    description: "We need a description here",
    tier: 1,
};
const ELEMENT_PILLAR: Element = Element {
    id: 133,
    name: "Pillar",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_PARCHED: Element = Element {
    id: 144,
    name: "Parched",
    description: "We need a description here",
    tier: 1,
};
const ELEMENT_FRESH: Element = Element {
    id: 145,
    name: "Fresh",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_GEOTHERMAL: Element = Element {
    id: 148,
    name: "Geothermal",
    description: "We need a description here",
    tier: 1,
};
const ELEMENT_ARTESIAN: Element = Element {
    id: 149,
    name: "Artesian",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_DRY: Element = Element {
    id: 152,
    name: "Dry",
    description: "We need a description here",
    tier: 1,
...
const ELEMENT_HOT: Element = Element {
    id: 164,
    name: "Hot",
    description: "We need a description here",
    tier: 1,
...
const RECIPE_MAKE_FROSTED: Recipe = Recipe {
    id: 48,
    a: 53,
    b: 25,
    c: 59,
...
const RECIPE_MAKE_WARM: Recipe = Recipe {
    id: 90,
    a: 26,
    b: 84,
    c: 85,
...
const RECIPE_MAKE_MOLTEN: Recipe = Recipe {
    id: 106,
    a: 26,
    b: 60,
    c: 95,
...
const RECIPE_MAKE_FERTILE: Recipe = Recipe {
    id: 124,
    a: 28,
    b: 86,
    c: 110,
...
const RECIPE_MAKE_SCORCHED: Recipe = Recipe {
    id: 129,
    a: 26,
    b: 114,
    c: 116,
...
const RECIPE_MAKE_FIRE: Recipe = Recipe {
    id: 133,
    a: 26,
    b: 117,
    c: 26,
...
const RECIPE_MAKE_CHARRED: Recipe = Recipe {
    id: 137,
    a: 26,
    b: 120,
    c: 122,
...
const RECIPE_MAKE_UNDERGROUND: Recipe = Recipe {
    id: 140,
    a: 25,
    b: 124,
    c: 125,
...
const RECIPE_MAKE_WHISPERING: Recipe = Recipe {
    id: 142,
    a: 31,
    b: 124,
    c: 126,
...
const RECIPE_MAKE_COOL: Recipe = Recipe {
    id: 146,
    a: 31,
    b: 127,
    c: 129,
...
const RECIPE_MAKE_ETERNAL: Recipe = Recipe {
    id: 149,
    a: 26,
    b: 130,
    c: 132,
};
const RECIPE_MAKE_PILLAR: Recipe = Recipe {
    id: 150,
    a: 31,
    b: 130,
    c: 133,
...
const RECIPE_MAKE_PARCHED: Recipe = Recipe {
    id: 165,
    a: 26,
    b: 142,
    c: 144,
};
const RECIPE_MAKE_FRESH: Recipe = Recipe {
    id: 166,
    a: 31,
    b: 142,
    c: 145,
...
const RECIPE_MAKE_GEOTHERMAL: Recipe = Recipe {
    id: 169,
    a: 26,
    b: 146,
    c: 148,
};
const RECIPE_MAKE_ARTESIAN: Recipe = Recipe {
    id: 170,
    a: 31,
    b: 146,
    c: 149,
...
const RECIPE_MAKE_DRY: Recipe = Recipe {
    id: 173,
    a: 26,
    b: 150,
    c: 152,
...
const RECIPE_MAKE_HOT: Recipe = Recipe {
    id: 191,
    a: 28,
    b: 35,
    c: 164,
...
fn find_item(index: u32) -> Option<Element> {
    ...
    if index == 125 {
        return Some(ELEMENT_UNDERGROUND);
    }
    if index == 126 {
        return Some(ELEMENT_WHISPERING);
    }
    if index == 127 {
    ...
    if index == 132 {
        return Some(ELEMENT_ETERNAL);
    }
    if index == 133 {
        return Some(ELEMENT_PILLAR);
    }
    if index == 134 {
    ...
    if index == 144 {
        return Some(ELEMENT_PARCHED);
    }
    if index == 145 {
        return Some(ELEMENT_FRESH);
    }
    if index == 146 {
    ...
    if index == 148 {
        return Some(ELEMENT_GEOTHERMAL);
    }
    if index == 149 {
        return Some(ELEMENT_ARTESIAN);
    }
    if index == 150 {
...
fn find_recipe(index: u32) -> Option<Recipe> {
    ...
    if index == 48 {
        return Some(RECIPE_MAKE_FROSTED);
    }
    if index == 49 {
    ...
    if index == 106 {
        return Some(RECIPE_MAKE_MOLTEN);
    }
    if index == 107 {
    ...
    if index == 124 {
        return Some(RECIPE_MAKE_FERTILE);
    }
    if index == 125 {
    ...
    if index == 129 {
        return Some(RECIPE_MAKE_SCORCHED);
    }
    if index == 130 {
        return Some(RECIPE_MAKE_BREEZE);
    }
    ...
    if index == 137 {
        return Some(RECIPE_MAKE_CHARRED);
    }
    if index == 138 {
    ...
    if index == 140 {
        return Some(RECIPE_MAKE_UNDERGROUND);
    }
    if index == 141 {
        return Some(RECIPE_MAKE_LAVA);
    }
    if index == 142 {
        return Some(RECIPE_MAKE_WHISPERING);
    }
    if index == 143 {
        return Some(RECIPE_MAKE_OASIS);
    }
    ...
    if index == 149 {
        return Some(RECIPE_MAKE_ETERNAL);
    }
    if index == 150 {
        return Some(RECIPE_MAKE_PILLAR);
    }
    if index == 151 {
        return Some(RECIPE_MAKE_RIVER);
    }
    ...
    if index == 165 {
        return Some(RECIPE_MAKE_PARCHED);
    }
    if index == 166 {
        return Some(RECIPE_MAKE_FRESH);
    }
    if index == 167 {
    ...
    if index == 169 {
        return Some(RECIPE_MAKE_GEOTHERMAL);
    }
    if index == 170 {
        return Some(RECIPE_MAKE_ARTESIAN);
    }
    if index == 171 {
