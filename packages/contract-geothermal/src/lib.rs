...
pub mod geothermal {
    ...
    /** Error type for PSP-22 compatible contract for element 'Geothermal' */
    ...
    impl Default for GeothermalContract {
        fn default() -> Self {
    ...
    impl GeothermalContract {
        /// Creates a new PSP-22 compatible Geothermal Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
        ...
        pub fn token_name(&self)-> String {
            String::from("Geothermal")
        }

        #[ink(message, selector = 0x34205be5)]
        pub fn token_symbol(&self)-> String {
            String::from("MGEOTHERMAL")
        }
