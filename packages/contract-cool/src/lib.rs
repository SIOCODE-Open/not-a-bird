...
pub mod cool {
    ...
    /** Error type for PSP-22 compatible contract for element 'Cool' */
    ...
    impl CoolContract {
        /// Creates a new PSP-22 compatible Cool Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
