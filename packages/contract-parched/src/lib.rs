...
pub mod parched {
    ...
    /** Error type for PSP-22 compatible contract for element 'Parched' */
    ...
    impl Default for ParchedContract {
        fn default() -> Self {
    ...
    impl ParchedContract {
        /// Creates a new PSP-22 compatible Parched Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
