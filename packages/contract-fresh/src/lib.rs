...
pub mod fresh {
    ...
    /** Error type for PSP-22 compatible contract for element 'Fresh' */
    ...
    impl Default for FreshContract {
        fn default() -> Self {
    ...
    impl FreshContract {
        /// Creates a new PSP-22 compatible Fresh Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
