...
pub mod eternal {
    ...
    /** Error type for PSP-22 compatible contract for element 'Eternal' */
    ...
    impl Default for EternalContract {
        fn default() -> Self {
    ...
    impl EternalContract {
        /// Creates a new PSP-22 compatible Eternal Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
