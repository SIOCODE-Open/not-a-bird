...
pub mod warm {
    ...
    /** Error type for PSP-22 compatible contract for element 'Warm' */
    ...
    impl WarmContract {
        /// Creates a new PSP-22 compatible Warm Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
