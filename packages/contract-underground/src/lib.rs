...
pub mod underground {
    ...
    /** Error type for PSP-22 compatible contract for element 'Underground' */
    ...
    #[ink(storage)]
    pub struct UndergroundContract {
        total_supply: u128,
    ...
    impl Default for UndergroundContract {
        fn default() -> Self {
    ...
    impl UndergroundContract {
        /// Creates a new PSP-22 compatible Underground Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
        ...
        pub fn token_name(&self)-> String {
            String::from("Underground")
        }

        #[ink(message, selector = 0x34205be5)]
        pub fn token_symbol(&self)-> String {
            String::from("MUNDERGROUND")
        }
