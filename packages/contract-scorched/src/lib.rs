...
pub mod scorched {
    ...
    /** Error type for PSP-22 compatible contract for element 'Scorched' */
    ...
    impl Default for ScorchedContract {
        fn default() -> Self {
    ...
    impl ScorchedContract {
        /// Creates a new PSP-22 compatible Scorched Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
        ...
        pub fn token_name(&self)-> String {
            String::from("Scorched")
        }

        #[ink(message, selector = 0x34205be5)]
        pub fn token_symbol(&self)-> String {
            String::from("MSCORCHED")
        }
