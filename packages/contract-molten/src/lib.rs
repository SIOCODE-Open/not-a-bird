...
pub mod molten {
    ...
    /** Error type for PSP-22 compatible contract for element 'Molten' */
    ...
    impl Default for MoltenContract {
        fn default() -> Self {
    ...
    impl MoltenContract {
        /// Creates a new PSP-22 compatible Molten Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
