...
pub mod charred {
    ...
    /** Error type for PSP-22 compatible contract for element 'Charred' */
    ...
    impl Default for CharredContract {
        fn default() -> Self {
    ...
    impl CharredContract {
        /// Creates a new PSP-22 compatible Charred Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
