...
pub mod frosted {
    ...
    /** Error type for PSP-22 compatible contract for element 'Frosted' */
    ...
    impl Default for FrostedContract {
        fn default() -> Self {
    ...
    impl FrostedContract {
        /// Creates a new PSP-22 compatible Frosted Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
