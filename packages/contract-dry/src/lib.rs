...
pub mod dry {
    ...
    /** Error type for PSP-22 compatible contract for element 'Dry' */
    ...
    impl DryContract {
        /// Creates a new PSP-22 compatible Dry Element contract
        #[ink(constructor)]
        pub fn new() -> Self {
            Self::default()
        }
